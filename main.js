...
function addCartClicked(event) {
    ...
    var produtoImg = shopProducts.getElementsByClassName("product-img")[0].src;
    addProcuctToCart(title, price, produtoImg);
    updatetotal();
}
function addProcuctToCart(title, price, produtoImg) {
    ...
    var cartBoxContent = `      <img src="${produtoImg}" alt="" class="cart-img">
